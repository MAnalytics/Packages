...
#' @usage outliers(traj, id_field = FALSE, method = 1, threshold = 0.95, hortz_tolerance = 1, replace_with = 1)
...
#' traj <- missingValue(traj, id_field=TRUE, replace_with=1)
#' outliers(traj, id_field = FALSE, method = 1, threshold = 0.95,
...
outliers <- function(traj, id_field = FALSE, method = 1, threshold = 0.95, hortz_tolerance = 1, replace_with = 1){
