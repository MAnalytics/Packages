...
akmedoids.clust <- function(traj, id_field = FALSE, method = "linear", k = c(3,6)){ #TRUE #k<-9 #traj <- sim_data_  #head(sim_data_)  #id_field = TRUE
