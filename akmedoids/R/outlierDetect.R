...
#' @description This function identifies outlier observations in the trajectories, and allows a user to replace the observations or remove trajectories entirely.
