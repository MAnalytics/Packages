...
#' @param digits [numeric] Round the values to the specified number of decimal places. Default: \code{4}.
#' @param scale [numeric] To scale the resulting values (if necessary). Default: \code{1}
#' @usage props(traj, id_field = TRUE, digits = 2, scale = 1)
#' @examples
#' traj <- traj
#' head(traj) #
